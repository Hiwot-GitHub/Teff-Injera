...
const AddToCartModal: React.FC<FirstAddToCartProps> = ({isOpen, closeFirstModal, item}) => {
  ...
  return(
    <>
    <Modal isOpen={isOpen} onRequestClose={closeFirstModal} style={{overlay:{background: 'rgba(0,0,0,0.5)'}}} className="w-[80%] sm:w-[50%] h-[100%] shadow-2xl ml-[20%] sm:ml-[50%]">
...
return (
  <Box>
    <Modal isOpen={isModalOpen} onRequestClose={closeModal} style={{overlay:{background: 'rgba(0,0,0,0.05)'}}} className="w-[60%] sm:w-[40%] h-[100%]  shadow-2xl ml-[40%] sm:ml-[60%] pl-4">
