...
const AddToCartModal: React.FC<FirstAddToCartProps> = ({isOpen, closeFirstModal, item}) => {
  ...
  return(
    <>
    <Modal isOpen={isOpen} onRequestClose={closeFirstModal} style={{overlay:{background: 'rgba(0,0,0,0.5)'}}} className="w-[80%] sm:w-[50%] h-[100%] bg-white dark:bg-Charchol shadow-2xl ml-[20%] sm:ml-[50%]">
