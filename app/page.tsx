...
export default function Home() {
  return (
    ...
    <Box className="z-50 ml-16" >
       ...
       <Card variant="ghost" size='3' className="top-[-28vh] sm:top-[-12vh] md:top-[4vh] lg:top-[16vh] sm:w-[22rem]  w-[25rem] h-[20rem]  z-50 ml-2 border-b border-l border-t border-r "><Heading m="2">Welcome!</Heading>
